...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//++Алекситович Д.Н. 24.04.2026 Добавление профилей групп доступа
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Бухгалтер ИТ-фирмы";
	ОписаниеПрофиля.Идентификатор = "8426f180-9252-4753-83c6-d14e32655c61";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОткрытиеКалендаря");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Бухгалтер по зарплате";
	ОписаниеПрофиля.Идентификатор = "8426f180-9252-5874-83c6-d14e32655c61";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Бухгалтер по зарплате'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "42d46928-3ed9-4f7a-8386-09f2acb99d4e";
	...
	ОписаниеПрофиля.Идентификатор = "305dba04-211c-471f-bbc2-7fcbe60ceb0b";
	...
	ОписаниеПрофиля.Идентификатор = "8426f180-9252-2657-83c6-d14e32655c61";
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСГрафикомРаботы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_НачислениеЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОткрытиеКалендаря");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
   //--
