...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ++ Алекситович Д.Н. 22.04.2026 Добавление на форму команды "Заполнить"
...
Процедура ВКМ_Заполнить(Команда)
	...
	ВидДоговора = ВКМ_ПолучитьВидДоговора(Объект.Договор);
...
&НаСервере
Функция ВКМ_ПолучитьВидДоговора(Договор)
...
Процедура ВКМ_ВыполнитьАвтозаполнение()
	...
	ДокументОбъект.ВКМ_ВыполнитьАвтозаполнениеНаСервере();
